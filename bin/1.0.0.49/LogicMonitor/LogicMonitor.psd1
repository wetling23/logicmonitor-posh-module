@{
    ...
    'Get-LogicMonitorDevices', 'Get-LogicMonitorDeviceSdt', 'Get-LogicMonitorPropertySource', 'Get-LogicMonitorSdt',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Added Get-LogicMonitorPropertySource (1.0.0.0).'
