@{
    ...
    'Get-LogicMonitorDashboardGroup', 'Get-LogicMonitorDashboardWidget', 'Get-LogicMonitorDataSource', 'Get-LogicMonitorDeviceDataSource',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Add-LogicMonitorDashboard to 1.0.0.3 (removed un-necessary property checks). Updated Get-LogicMonitorConfigSourceData to 1.0.0.1 (returning all instance properties, not just config content). Updated Add-LogicMonitorDashboardWidget to 1.0.0.1 (removed some error logging content).'
