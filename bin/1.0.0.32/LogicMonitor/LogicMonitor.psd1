@{
    ...
    'Get-LogicMonitorCollectors', 'Get-LogicMonitorDataSources', 'Get-LogicMonitorDeviceGroupProperties',
    'Get-LogicMonitorDeviceGroups', 'Get-LogicMonitorDeviceProperties', 'Get-LogicMonitorDevices',
    'Get-LogicMonitorSdt', 'Get-LogicMonitorServiceProperties', 'Get-LogicMonitorRoles',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Get-LogicMonitorAlertRules to 1.0.0.1 (new functionality). Added Update-LogicMonitorAlertRulesProperties.'
