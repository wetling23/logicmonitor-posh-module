@{
    ...
    'Get-LogicMonitorDeviceProperties', 'Get-LogicMonitorDevices', 'Get-LogicMonitorDeviceSdt', 
    'Get-LogicMonitorSdt', 'Get-LogicMonitorServiceProperties', 'Get-LogicMonitorRoles', 'Get-LogicMonitorServices',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Added Get-LogicMonitorDeviceSdt (1.0.0.0). Updated Get-LogicMonitorSdt to 1.0.0.3 (parameter change).'
