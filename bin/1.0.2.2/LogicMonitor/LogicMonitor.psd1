@{
    ...
    'Disable-LogicMonitorDataSourceInstance',
    'Enable-LogicMonitorDataSourceInstance',
    ...
    'Get-LogicMonitorRawData', 'Get-LogicMonitorRole', 'Get-LogicMonitorSdt', 'Get-LogicMonitorUser', 'Get-LogicMonitorWebsite', 'Get-LogicMonitorWebsiteGroup',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Renamed Disable-DataSourceInstance and Enable-DataSourceInstance to Disable-LogicMonitorDataSourceInstance and Enable-LogicMonitorDataSourceInstance respectively (retained old names as alias).'
