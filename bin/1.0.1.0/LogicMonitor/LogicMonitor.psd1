@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Get-LogicMonitorDeviceDataSource to 1.0.0.1 (fixed bug). Updated Get-LogicMonitorDevice to 1.0.0.11 (added alias). Updated Add-LogicMonitorDevice to 1.0.0.12 (update whitespace). Updated Add-EventLogSource to 1.0.0.8 (updated output). Updated Get-LogicMonitorDeviceSdt to 1.0.0.2 (added error msg). Updated all cmdlets to support LM rate-limiting response.'
