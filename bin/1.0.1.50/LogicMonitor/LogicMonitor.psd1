@{
    ...
    'Get-LogicMonitorDevice', 'Get-LogicMonitorEscalationChain', 'Get-LogicMonitorEventSource', 'Get-LogicMonitorRole', 'Get-LogicMonitorDeviceSdt',
    'Get-LogicMonitorPropertySource', 'Get-LogicMonitorReportGroup', 'Get-LogicMonitorRawData', 'Get-LogicMonitorSdt', 'Get-LogicMonitorWebsite',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Added Get-LogicMonitorEventSource to 1.0.0.0.'
