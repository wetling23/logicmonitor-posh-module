@{
    ...
    FunctionsToExport = 'Add-EventLogSource', 'Add-LogicMonitorAlertRule', 'Add-LogicMonitorCollector', 'Add-LogicMonitorDashboardGroup',
    'Add-LogicMonitorDevice', 'Add-LogicMonitorDeviceGroup', 'Add-LogicMonitorReportGroup', 'Add-LogicMonitorWebsiteGroup',
    ...
    'Get-LogicMonitorCollectorUpgradeHistory', 'Get-LogicMonitorConfigSource', 'Get-LogicMonitorDashboard',
    'Get-LogicMonitorDashboardWidget', 'Get-LogicMonitorDataSource', 'Get-LogicMonitorDeviceDataSource',
    'Get-LogicMonitorDeviceGroupProperty', 'Get-LogicMonitorDeviceGroup', 'Get-LogicMonitorDeviceProperty',
    'Get-LogicMonitorDevice', 'Get-LogicMonitorEscalationChain', 'Get-LogicMonitorRole', 'Get-LogicMonitorDeviceSdt', 'Get-LogicMonitorPropertySource',
    'Get-LogicMonitorReportGroup', 'Get-LogicMonitorRawData', 'Get-LogicMonitorSdt', 'Get-LogicMonitorWebsite',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Get-LogicMonitorAlert to 1.0.0.11 (added configurable start/end dates and a hash table filter). Updated Get-LogicMonitorSdt to 1.0.0.10 (added hash table filter).'
