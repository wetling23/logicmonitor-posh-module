@{
    ...
    'Add-LogicMonitorDashboardGroup', 'Add-LogicMonitorDevice', 'Add-LogicMonitorDeviceGroup', 'Add-LogicMonitorReportGroup',
    'Add-LogicMonitorWebsiteGroup',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Get-LogicMonitorDashboard to 1.0.0.6 (fixed bug in name query, when there are zero results) and added Add-LogicMonitorDashboard.'
