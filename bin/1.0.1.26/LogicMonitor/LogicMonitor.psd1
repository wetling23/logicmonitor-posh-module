@{
    ...
    FunctionsToExport = 'Add-EventLogSource', 'Add-LogicMonitorCollector', 'Add-LogicMonitorDashboardGroup',
    ...
    'Get-LogicMonitorReportGroup', 'Get-LogicMonitorSdt', 'Get-LogicMonitorWebsite', 'Get-LogicMonitorWebsiteGroup',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Added Add/Get-LogicMonitorWebsiteGroup, Add/Get-LogicMonitorDashboardGroup, Add/Get-LogicMonitorReportGroup.'
