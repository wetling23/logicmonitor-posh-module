@{
    ...
    'Get-LogicMonitorServiceProperties', 'Get-LogicMonitorRoles', 'Get-LogicMonitorServices',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Get-LogicMonitorCollectorUpgradeHistory 1.0.0.2 (wording change). Updated Get-LogicMonitorCollectors to 1.0.0.11 (updated default batchsize)'
