@{
    ...
    'Get-LogicMonitorCollectorUpgradeHistory', 'Get-LogicMonitorConfigSource', 'Get-LogicMonitorDashboard', 'Get-LogicMonitorDashboardGroup',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Add-LogicMonitorDashboard to 1.0.0.2 (removed test and unrelated code). This is not my day.'
