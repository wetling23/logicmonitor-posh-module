@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Get-LogicMonitorConfigSource to 1.0.0.8 (changed collection handling). Updated Get-LogicMonitorAlert to 1.0.0.12 (added Start/EndDate params to "Filter" parameter set).'
