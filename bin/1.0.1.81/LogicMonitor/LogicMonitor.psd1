@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Out-PsLogging to 1.0.0.8 (forced utf8 encoding). Added Add-LogicMonitorWebsite. Updated the following cmdlets to encode body data in utf8. See https://github.com/wetling23/logicmonitor-posh-module/issues/12 for details.

            Add-LogicMonitorAlertRule
            Add-LogicMonitorCollector
            Add-LogicMonitorDashboard
            Add-LogicMonitorDashboardGroup
            Add-LogicMonitorDashboardWidget
            Add-LogicMonitorDevice
            Add-LogicMonitorDeviceGroup
            Add-LogicMonitorReportGroup
            Add-LogicMonitorWebsite
            Add-LogicMonitorWebsiteGroup
            Remove-LogicMonitorCollectorVersion
            Send-LogicMonitorLmLogEntry
            Start-LogicMonitorDeviceSdt
            Start-LogicMonitorSdt
