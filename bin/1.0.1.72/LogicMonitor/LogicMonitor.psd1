@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Get-LogicMonitorDashboardGroup and Get-LogicMonitorReportGroup to 1.0.0.2 (added support for generic filters).'
