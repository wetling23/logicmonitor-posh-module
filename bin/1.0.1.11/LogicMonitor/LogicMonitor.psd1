@{
    ...
    'Get-LogicMonitorDataSource', 'Get-LogicMonitorDeviceDataSource', 'Get-LogicMonitorDeviceGroupProperty',
    'Get-LogicMonitorDeviceGroup', 'Get-LogicMonitorDeviceProperty', 'Get-LogicMonitorDevice', 'Get-LogicMonitorRole',
    'Get-LogicMonitorDeviceSdt', 'Get-LogicMonitorPropertySource', 'Get-LogicMonitorSdt', 'Get-LogicMonitorWebsite',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Add-LogicMonitorDeviceGroup: Changed the way properties are handled. Get-LogicMonitorCollectorInstaller: Added support for selecting collector size. Add-LogicMonitorDevice: Changed the way properties are handled. Added Get-LogicMonitorDashboardWidget.'
