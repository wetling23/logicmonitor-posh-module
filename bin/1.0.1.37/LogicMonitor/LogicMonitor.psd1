@{
    ...
    'Out-PsLogging',
    'Remove-LogicMonitorCollector', 'Remove-LogicMonitorCollectorVersion',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Added Add-LogicMonitorAlertRule and Get-LogicMonitorEscalationChain.'
