@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Get-LogicMonitorConfigSourceData to 1.0.0.4 (return "No data" when there is no error retrieving data, but the CS is not applied).'
