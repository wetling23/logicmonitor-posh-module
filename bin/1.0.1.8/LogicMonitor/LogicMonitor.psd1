@{
    ...
    'Get-LogicMonitorCollectorUpgradeHistory', 'Get-LogicMonitorConfigSource', 'Get-LogicMonitorDataSource',
    'Get-LogicMonitorDeviceDataSource', 'Get-LogicMonitorDeviceGroupProperty', 'Get-LogicMonitorDeviceGroup',
    'Get-LogicMonitorDeviceProperty', 'Get-LogicMonitorDevice', 'Get-LogicMonitorRole', 'Get-LogicMonitorDeviceSdt',
    'Get-LogicMonitorPropertySource', 'Get-LogicMonitorSdt', 'Get-LogicMonitorWebsite', 'Get-LogicMonitorWebsiteProperty',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Added Update-LogicMonitorAlertRule and updated Update-LogicMonitorAlertRuleProperty to 1.0.0.3 (marked as deprecated).'
