@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated some of the cmdlets with -Filter parameter, to support URL encoding of special characters in the filter: Get-LogicMonitorAlertRule, Get-LogicMonitorCollector, Get-LogicMonitorDashboardGroup, Get-LogicMonitorDevice, Get-LogicMonitorReport, Get-LogicMonitorReportGroup, Get-LogicMonitorWebsite, Get-LogicMonitorWebsiteGroup.
            
            Removed irrelevant logging from Get-LogicMonitorDataSourceDevice.
            
            Changed parameter set name in Get-LogicMonitorSdt, to align with naming convention.'
