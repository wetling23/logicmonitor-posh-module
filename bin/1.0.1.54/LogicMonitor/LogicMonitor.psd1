@{
    ...
    'Get-LogicMonitorJobMonitor', 'Get-LogicMonitorPropertySource', 'Get-LogicMonitorReportGroup', 'Get-LogicMonitorRawData', 'Get-LogicMonitorRole',
    'Get-LogicMonitorSdt', 'Get-LogicMonitorWebsite', 'Get-LogicMonitorWebsiteGroup', 'Get-LogicMonitorWebsiteProperty',
    'Out-PsLogging',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Send-LogicMonitorAuditLog to 1.0.0.12 (added support for additional filtering).'
